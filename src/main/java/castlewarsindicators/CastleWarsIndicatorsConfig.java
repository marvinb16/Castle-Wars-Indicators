...
@ConfigGroup("castlewarsindicators")
public interface CastleWarsIndicatorsConfig extends Config
{
	@ConfigItem(
			position = 0,
	...
	default boolean enablePersistentNotify() { return true; }
	...
	default int persistentNotifyIntervalSeconds() { return 10; }
